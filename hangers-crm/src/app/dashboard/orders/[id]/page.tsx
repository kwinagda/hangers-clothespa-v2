            ...
            <div className="crm-whatsapp-body" style={{padding:22,display:'grid',gap:12,overflowY:'auto',minHeight:0}}>
              ...
              <div style={{border:'1px solid #dce8f0',borderRadius:12,background:'#f8fafc',padding:12,minHeight:260}}>
                ...
                {manualWhatsAppPreview?.error ? (
                  ...
                  <>
                    {(manualWhatsAppPreview?.paymentAccount?.qrImageDataUrl || manualWhatsAppPreview?.qrImage) && <img src={manualWhatsAppPreview.paymentAccount?.qrImageDataUrl || manualWhatsAppPreview.qrImage} alt="Payment QR preview" style={{width:96,height:96,objectFit:'contain',border:'1px solid #dce8f0',borderRadius:10,background:'#fff',marginBottom:10}} />}
