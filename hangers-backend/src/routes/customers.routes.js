...
const { listCustomers, getCustomer, getReferralReport, createCustomer, updateCustomer, addCustomerAddress, updateCustomerAddress, getCustomerStats, updateCustomerTag } = require('../controllers/customers.controller');
...
router.patch('/:id/addresses/:addressId', staffAuth, crmAccess, requirePermission('customers.edit'), updateCustomerAddress);
