...
const { getSettings, updateSettings, getPublicSettings, getPaymentAccountQrImage } = require('../controllers/settings.controller');
...
router.get('/payment-accounts/:accountId/qr', getPaymentAccountQrImage);
