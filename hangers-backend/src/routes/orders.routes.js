...
router.post('/:id/notifications/preview', staffAuth, crmAccess, requirePermission('orders.update_status'), previewManualOrderNotification);
router.post('/:id/notifications/manual', staffAuth, crmAccess, requirePermission('orders.update_status'), idempotent({ scope: 'orders.notification-manual' }), sendManualOrderNotification);
